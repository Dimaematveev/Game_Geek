    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                int y;
                var resY = playController.CurrentTeam.Figures.Select(f => f.PozY).ToArray();
                ...
                int x;
                var resX = playController.CurrentTeam.Figures.Where(f => f.PozY == y).Select(f => f.PozX).ToArray();
